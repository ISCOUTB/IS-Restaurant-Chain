...
def add_product_to_order(order_id: str, product: Inventory):
    if not order_use_cases.add_product_to_order(ObjectId(order_id), product):
...
def remove_product_from_order(order_id: str, product_id: str):
    if not order_use_cases.remove_product_from_order(ObjectId(order_id), ObjectId(product_id)):
